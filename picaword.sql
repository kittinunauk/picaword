...
--
-- Host: localhost
-- Generation Time: Nov 20, 2016 at 11:21 AM
...
(1, 'Foods and Drinks', 'This is first deck.', 'Admin', ''),
(2, 'Jot Down', '', 'Admin', '');
...
--
ALTER TABLE `Card`
  MODIFY `CID` int(64) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
